...
### Descripción 
---
helloIW_Shrd` es una función que permite la comunicación entre diferentes procesos a través del uso de memoria compartida. La memoria compartida es un segmento de memoria que puede ser accedido por múltiples procesos, lo que permite el intercambio de datos de manera eficiente sin necesidad de utilizar mecanismos de comunicación más lentos como sockets o archivos.
